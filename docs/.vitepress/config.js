...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: 'Русский', link: '/ru_RU/' },
          { text: '日本語', link: '/ja_JP/' },
          { text: 'Português (Brasil)', link: '/pt_BR/' },
          { text: 'Bahasa Indonesia', link: '/id_ID/' },
          { text: 'Tiếng Việt', link: '/vi_VN/' },
          { text: '正體中文', link: '/zh_TW/' }
        ]
      }
    ],
    ...
    editLink: {
      pattern: 'https://github.com/KernelSU-Next/website/edit/main/docs/:path',
